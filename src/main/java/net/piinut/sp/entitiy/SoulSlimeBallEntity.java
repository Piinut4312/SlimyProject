...
public class SoulSlimeBallEntity extends ThrownItemEntity {

    public SoulSlimeBallEntity(EntityType<? extends ThrownItemEntity> entityType, World world) {
        super(entityType, world);
    }

    public SoulSlimeBallEntity(World world, LivingEntity owner) {
        super(ModEntityRegistry.SOUL_SLIME_BALL_ENTITY_TYPE, owner, world);
    }

    public SoulSlimeBallEntity(World world, double x, double y, double z) {
        super(ModEntityRegistry.SOUL_SLIME_BALL_ENTITY_TYPE, x, y, z, world);
    }

    @Override
    protected Item getDefaultItem() {
        return ModItemRegistry.SOUL_SLIME_BALL;
    }

    @Environment(EnvType.CLIENT)
    private ParticleEffect getParticleParameters() {
        ItemStack itemStack = this.getItem();
        return itemStack.isEmpty() ? new ItemStackParticleEffect(ParticleTypes.ITEM, new ItemStack(ModItemRegistry.SOUL_SLIME_BALL)) : new ItemStackParticleEffect(ParticleTypes.ITEM, itemStack);
    }
    ...
    protected void onCollision(HitResult hitResult) {
        ...
        if (!this.world.isClient) {
            ...
            BlockState blockState = ModBlockRegistry.SOUL_SLIME_LAYER.getDefaultState();
